...
class _$_DataModel implements _DataModel {
  ...
  @override
  String toString() {
    return 'DataModel(id: $id, title: $title, worth: $worth, thumbnail: $thumbnail, image: $image, description: $description, instructions: $instructions, openGiveawayUrl: $openGiveawayUrl, publishedDate: $publishedDate, type: $type, platforms: $platforms, endDate: $endDate, users: $users, status: $status, gamerpowerUrl: $gamerpowerUrl, openGiveaway: $openGiveaway)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.openGiveaway, openGiveaway));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(openGiveaway));
...
abstract class _DataModel implements DataModel {
  factory _DataModel(
      ...
      String? status,
      String? gamerpowerUrl,
      String? openGiveaway}) = _$_DataModel;
